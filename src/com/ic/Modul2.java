...
public class Modul2 extends Activity implements OnClickListener, OnItemSelectedListener {
	private Model model;
	private EditText blockid;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_modul2, menu);
		return true;
	}
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		case R.id.spPT:
			...
			} else if (pt.getItemAtPosition(arg2).toString().equals("Siringo - Ringo")) {
				companyID = "3";
				listestate.add("Siringo - Ringo");
				estate.setAdapter(new ArrayAdapter<String>(this,
						android.R.layout.simple_spinner_dropdown_item, listestate));
			} else if (pt.getItemAtPosition(arg2).toString().equals("Agrowitama - Padang")) {
				companyID = "4";
		...
		case R.id.spEstate:
			...
			if (estate.getItemAtPosition(estate.getSelectedItemPosition()).toString().equalsIgnoreCase("1")) {
				...
				division.setAdapter(new ArrayAdapter<String>(this,
						android.R.layout.simple_spinner_dropdown_item,
						listdivisi));
			} else if (estate.getItemAtPosition(estate.getSelectedItemPosition()).toString().equalsIgnoreCase("Siringo-Ringo")) {
				estateID = "9";
				listdivisi.add("A");
				listdivisi.add("B");
				listdivisi.add("C");
				division.setAdapter(new ArrayAdapter<String>(this,
						android.R.layout.simple_spinner_dropdown_item,
						listdivisi));
			} else if (estate.getItemAtPosition(estate.getSelectedItemPosition()).toString().equalsIgnoreCase("Sei Alur")) {
				estateID = "10";
				listdivisi.add("A");
				listdivisi.add("B");
				listdivisi.add("C");
