...
@SuppressLint("NewApi")
public class Modul3 extends Activity implements OnClickListener,
	...
	public void onClick(View arg0) {
		...
		case R.id.btnNext:
			...
			if (!blockid.getText().toString().isEmpty()
					&& !rotasipanen.getText().toString().isEmpty()) {
				...
				Intent ancak = new Intent(this, TPHSelection.class);
