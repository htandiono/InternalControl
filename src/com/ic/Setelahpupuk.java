...
public class Setelahpupuk extends Activity implements OnClickListener,
	...
	private CheckBox cbPupuk2, cbPupuk31, cbPupuk32, cbPupuk33, cbPupuk6,
			cbPupuk51, cbPupuk52, cbPupuk53, cbPupuk5;
	private Button btnPupuk8, btnPupuk9, btnPupuk10, btnPupuk11;
	private ArrayList<String> pupuk1List, pupuk4List, pupuk7List;
	private TextView Pokok, Time,tvPupuk51,tvPupuk52,tvPupuk53;
	private String pupuk1Data, pupuk4Data, pupuk7Data, empCode;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_setelahpupuk);
		...
		cbPupuk5 = (CheckBox) findViewById(R.id.cbPupuk5);
		cbPupuk51 = (CheckBox) findViewById(R.id.cbPupuk51);
		cbPupuk52 = (CheckBox) findViewById(R.id.cbPupuk52);
		cbPupuk53 = (CheckBox) findViewById(R.id.cbPupuk53);
		...
		if (model.getArealAplikasi().equalsIgnoreCase("0")){
			cbPupuk5.setVisibility(View.VISIBLE);
			tvPupuk51.setVisibility(View.GONE);
			tvPupuk52.setVisibility(View.GONE);
			tvPupuk53.setVisibility(View.GONE);
			cbPupuk51.setVisibility(View.GONE);
			cbPupuk52.setVisibility(View.GONE);
			cbPupuk53.setVisibility(View.GONE);
		}else{
			cbPupuk5.setVisibility(View.GONE);
			tvPupuk51.setVisibility(View.VISIBLE);
			tvPupuk52.setVisibility(View.VISIBLE);
			tvPupuk53.setVisibility(View.VISIBLE);
			cbPupuk51.setVisibility(View.VISIBLE);
			cbPupuk52.setVisibility(View.VISIBLE);
			cbPupuk53.setVisibility(View.VISIBLE);
		}
		try {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_setelahpupuk, menu);
		return true;
	}
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		switch (arg0.getId()) {
		case R.id.spPupuk1:
			if (spPupuk1.getItemAtPosition(arg2).toString()
					.equals("Barren/Steril")) {
				pupuk1Data = "b";
			} else if (spPupuk1.getItemAtPosition(arg2).toString()
					.equals("Mati/Kosong")) {
				pupuk1Data = "x";
			} else if (spPupuk1.getItemAtPosition(arg2).toString()
					.equals("Sisipan")) {
	...
	private void saveData() {
		...
		String pupuk5 = "0";
		if (cbPupuk5.isChecked()) {
			pupuk5 = "-1";
		}
		String pupuk51 = "0";
		if (cbPupuk51.isChecked()) {
			pupuk51 = "-1";
		}
		String pupuk52 = "0";
		if (cbPupuk52.isChecked()) {
			pupuk52 = "-1";
		}
		String pupuk53 = "0";
		if (cbPupuk53.isChecked()) {
			pupuk53 = "-1";
		}
		String pupuk6 = "0";
		...
		// save to data code
		try {
			model.storeFRTSesudah(empCode, pupuk1Data, pupuk2, pupuk31,
					pupuk32, pupuk33, pupuk4Data, pupuk5, pupuk51, pupuk52,
					pupuk53, pupuk6, pupuk7Data, Time );
	...
	public void update(Observable arg0, Object arg1) {
		...
		cbPupuk51.setChecked(false);
		cbPupuk52.setChecked(false);
		cbPupuk53.setChecked(false);
	...
	private class readRecord extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressBar = new ProgressDialog(Setelahpupuk.this);
		...
		protected Void doInBackground(Void... arg0) {
			...
			found = false;
			try {
				found = model.readFRTPupukSesudah();
		...
		protected void onPostExecute(Void result2) {
			...
			if (found) {
				...
				try {
					result = model.readFRTPupukSesudahDetail();
					int pupuk1 = 0;
					...
					if (result.get(6).equals("-1")){
						cbPupuk5.setChecked(true);
					}
					if (result.get(7).equals("-1")){
						cbPupuk51.setChecked(true);
					}
					if(result.get(8).equals("-1")){
						cbPupuk52.setChecked(true);
					}
					if(result.get(9).equals("-1")){
						cbPupuk53.setChecked(true);
					}
